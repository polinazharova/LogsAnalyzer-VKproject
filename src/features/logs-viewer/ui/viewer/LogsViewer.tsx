...
const LogsViewer: React.FC = () => {
  ...
  switch (isReading) {
    case 0: {
      return <NoFilesChosen />;
    }
    case 1: {
      return <div>Reading in process...</div>;
    }
    case 2: {
      if (logs) {
        return (
          <div className="main__log-viewer">
            ...
            <LogItems
              ...
              setFirstShownIndex={setFirstShownIndex}
            />
            <LogSwitcher
              firstShownIndex={firstShownIndex}
              setFirstShownIndex={setFirstShownIndex}
    ...
    default: {
      return (
        <div className="main__log-viewer-items">Something went wrong!</div>
      );
    }
  }
};
