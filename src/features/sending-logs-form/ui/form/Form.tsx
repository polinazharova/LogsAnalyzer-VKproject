...
const Form: React.FC = () => {
    ...
    return(
        <form className={formClass} action="" onSubmit={handleFormSubmit} ref={formRef}>
            <FileInput formClass={formClass} inputId="log-file-input" handleFileChange={handleFileChange}/>
            <AttachedFiles formClass={formClass} filesAttached={filesAttached} handleClickClearingAttachedFiles={handleClickClearingAttachedFiles}/>
